...
# Cache loading resources for speed
@st.cache_data
def load_resources():
    df = pd.read_csv("cleaned_data.csv")

    # Clean cost and rating columns
...
if page == "Home":
    ...
    **Swiggy’s Restaurant Recommendation System using Streamlit**
    ...
    ### About This Project
    This project demonstrates how to build a restaurant recommendation system that clusters restaurants based on city, cuisine, ratings, and cost. It uses machine learning (K-Means clustering) to suggest restaurants similar to the user's preferences, helping users discover dining options efficiently.

    Developed by: **Suriya Jaganmohan**
    """)
    st.markdown("---")
...
# ----- RECOMMENDATIONS PAGE -----
    ...
    max_cost = st.slider("💰 Maximum Cost (₹)", 100, 2000, 500, step=50)
